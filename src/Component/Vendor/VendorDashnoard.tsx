...
function VendorDashnoard() {
  ...
  return (
    <div className="min-h-screen w-screen relative mt-20 flex justify-center bg-linear-to-br from-gray-700 via-black to-gray-900 text-white">
      ...
      <div className="">
        ...
        >
          <h1 className="text-xl">Vendor Dashboard</h1>
          <AiOutlineMenu
      ...
      <motion.div 
        ...
        className="w-full md:w-[80%] h-full mt-15 md:mt-0">
            {renderPage()}
      </motion.div>
    </div>
  );
...
export default VendorDashnoard;
